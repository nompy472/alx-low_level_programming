 ...
 * @e_ident: pointer to array with ELF numbers
 ...
 * @e_ident: A pointer to an array with ELF class
 */
 ...
 * @e_ident: pointer to array of the ELF version
 */
...
/**
 * print_abi - prints the ABI version of ALF header
 * @e_ident: pointer to the array with ELF ABI version
 */
 ...
 * Return: 0
 * Description: if file is not ELF or function fails
 * -exit code 98
 */
