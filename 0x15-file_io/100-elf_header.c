...
/**
 * print_class - Printsclass of an ELF header.
...
/**
 * check_elf - Checks a file if it's an ELF file.
 ...
 * @e_ident: pointer to  array with the ELF version.
 */
...
/**
 * main - shows whats in the ELF header at the start of an ELF file
